...
function Bricks3() {
    ...
    let bricks3 = [8, 2, 6, 0, 2] //result should be 6

    function spotsFilledByWater(bricks3, spaceWithin){
    ...
    // 
    let spaceWithin = bricks3.length;
    
    //Check brickfilled sequence in log;
    console.log(spotsFilledByWater(bricks3, spaceWithin));
 
    function handleBricks2(){
        document.getElementById("bricks3").innerText = ("The brick sequence is ") + bricks3 +"."+ " This can hold " + spotsFilledByWater(bricks3, spaceWithin) + " bricks of water."
      }
